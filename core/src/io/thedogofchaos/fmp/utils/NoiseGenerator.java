...
public class NoiseGenerator {
    public static double[] generateNoise(String noiseType, int mapWidth, int mapHeight, int noiseExponent) {
        return switch (noiseType) {
            case "perlin" -> normalise(perlinNoise(mapWidth, mapHeight, noiseExponent));
            case "smooth" -> normalise(smoothNoise(mapWidth, mapHeight, noiseExponent));
            case "turbulence" -> normalise(turbulence(mapWidth, mapHeight, noiseExponent));
